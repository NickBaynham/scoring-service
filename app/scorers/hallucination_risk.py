...
class HallucinationRiskScorer(BaseScorer):
    """Higher score means higher risk of fabrication."""

    @property
    def dimension(self) -> ScoreDimension:
        return ScoreDimension.HALLUCINATION_RISK

    async def score(self, document_text: str, *, correlation_id: str | None = None) -> NormalizedScoreResult:
        user = dimension_prompt(ScoreDimension.HALLUCINATION_RISK, document_text)
