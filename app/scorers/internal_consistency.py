...
class InternalConsistencyScorer(BaseScorer):
    """Detects contradictions and terminology drift."""

    @property
    def dimension(self) -> ScoreDimension:
        return ScoreDimension.INTERNAL_CONSISTENCY

    async def score(self, document_text: str, *, correlation_id: str | None = None) -> NormalizedScoreResult:
        user = dimension_prompt(ScoreDimension.INTERNAL_CONSISTENCY, document_text)
